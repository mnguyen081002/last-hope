...
| `Shelters/20_MainShelter` | `location_shelter` — `StorageView`, `ShelterConsoleView`, `BedView` (P3, 2026-07-28), 2 `TravelPointView` (→ store, → gara — BL-P2-12), mỗi cái 1 `PlayerSpawnPoint` riêng sát cạnh, gắn đúng `RouteId` |
