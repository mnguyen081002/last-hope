...
namespace LastHope.Core.Rules
{
    ...
    {
        /// <summary>units_delta = inflow(phase, backflow) - passive_drain - pump_output.
        /// activePumpCount is always 0 until S11 ships the Portable Pump module.</summary>
        public static float ComputeDelta(int rainIntensity, bool backflowActive, int activePumpCount, ShelterBalance cfg)
        {
